...
const HomeFeature: FC = () => {
  return (
    <Box id="services" sx={{ py: { xs: 10, md: 14 }, backgroundColor: 'background.paper' }}>
      <Container >
        <Grid sx={{ display: 'flex', justifyContent: 'center' }} container spacing={3}>
          <Grid item xs={12} md={7}>
            ...
            RASCO is committed to providing high-quality services to private organizations, public institutions, faith-based organizations, and civil societies, contributing to the socio-economic transformation of Africa and beyond
            </Typography>
